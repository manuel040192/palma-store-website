            ...
            >
                ...
                >
                    <div style={{ position: 'relative' }}>
                        <Link to='/'><img src='images/IMG_2714.jpg' alt='' style={{ width: 350, height: 310, objectFit: 'cover' }}/></Link>
                        <span style={{ position: 'absolute', top: 135, left: 140, color: '#ffffff', fontFamily: 'Rajdhani', fontSize: 28, fontWeight: 400 }}></span>    
                    </div>
                    <div style={{ position: 'relative' }}>
                        <Link to='/'><img src='images/IMG_2711.jpg' alt='' style={{ width: 350, height: 310, objectFit: 'cover' }}/></Link>
